...
const animalShowCase = document.getElementById(animalShow) as HTMLDivElement;
let animalstart = document.createElement(div) as HTMLDivElement;
const btnStart = document.getElementById(btnStrt) as HTMLButtonElement;
const win = document.getElementById("winner") as HTMLDivElement;
    ...
    id = setInterval(() => {
      animalArray.forEach((animal) => {
        ...
        animalRace.forEach((a, i) => {
          let animalImage = a as HTMLImageElement;
